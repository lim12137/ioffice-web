...
import { app, BrowserWindow, nativeImage, powerMonitor, screen } from '@/platform/electron';
import type { NativeImage } from '@/platform/electron';
...
const createWindow = (): void => {
  ...
  let devIcon: NativeImage | undefined;
  if (!app.isPackaged) {
    try {
