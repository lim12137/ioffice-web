...
export class SessionManager {
   ...
   */
  createSession(user: IChannelUser, agentType: ChannelAgentType = 'codex', workspace?: string, chatId?: string): IChannelSession {
   ...
   */
  createSessionWithConversation(user: IChannelUser, conversationId: string, agentType: ChannelAgentType = 'codex', workspace?: string, chatId?: string): IChannelSession {
    const db = getDatabase();
